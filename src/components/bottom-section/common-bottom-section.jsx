...
function CommonBottomSection() {
  return (
    <div className="w-full h-max bg-blueBottom-gradient flex flex-col py-12 px-4 gap-6 items-center xl:flex-row xl:min-h-[500px] xl:justify-between xl:px-40 overflow-hidden  ">
      <div className="w-max h-max flex flex-col items-center gap-6 min-h-32 xl:self-start xl:mt-16 xl:items-start xl:gap-10">
        ...
        <div className="w-full flex max-w-[250px] h-full ease-in-out duration-200 sm:max-w-[400px] ">
          <Button
            text="Register here"
            style="secondary"
            customStyle="font-bold p-3 border-[1px] sm:text-xl ease-in-out duration-200 xl:py-4 xl:max-w-[250px] xl:text-base"
          />
        </div>
      </div>
