...
function AllCoursesButton() {
  return (
    <Link
      href="courses"
      className="h-16 broder-2 border-black bg-blueButton px-8 py-4 rounded-2xl text-white font-bold flex items-center sm:text-base hover:bg-blue-100 hover:text-blueButton hover:outline hover:outline-1 hover:outline-blueButton ease-in-out duration-300 "
    >
      Explore Courses
    </Link>
  );
...
function HeroSection() {
  return (
    <div className="w-full h-[704px] flex flex-col lg:justify-center pt-[9%] lg:pt-0 ">
      <div className="w-full px-4 h-max z-10 flex flex-col items-start gap-5 ease-in-out duration-200 sm:px-16 lg:w-8/12  lg:gap-14 lg:px-40 min-[1800px]:px-96 ">
