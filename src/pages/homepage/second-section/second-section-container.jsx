...
function HomepageSecondSection() {
  ...
  return (
    <div className="relative w-full h-max flex sm:flex-col ">
      <div className="flex flex-col px-4 py-16 gap-8 sm:px-20 ease-in-out duration-200 lg:px-40 lg:gap-24">
        <SectionTwoBox
          ...
          style="w-full h-auto object-cover z-10 lg:w-max xl:max-w-[454px] min-[1700px]:w-full min-[1700px]:h-[400px]"
        />
        <SectionTwoBox
          ...
          bottomImageUrl="homepage/second-section-materials/section-2-heart.svg"
          featureDescription={featureDescription}
          style="w-full h-auto object-cover z-10 lg:w-max xl:max-w-[454px] min-[1700px]:w-[full] min-[1700px]:h-[400px] lg:order-2"
        />
      </div>
