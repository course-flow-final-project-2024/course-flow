  ...
  return (
    <div className="w-full h-[576px] sm:h-[840px] mt-5 relative">
      <Image
        ...
        height={117}
        alt="vector-8"
        className="absolute z-10 top-0 md:top-[0%] right-0 min-[426px]:w-[90px] min-[426px]:w-[310px] md:w-[175px] md:h-[620px]  "
      />
      <Image
        ...
        height={108}
        alt="vector-9"
        className="absolute z-10 bottom-0 left-0 md:left-[-2%] min-[426px]:w-[60px] min-[426px]:w-[210px] md:w-[115px] md:h-[420px] "
      />
      <Image
