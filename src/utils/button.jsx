export default function Button(prop) {
  ...
  if (prop.style === "primary") {
    //blue button
    style = `grow h-[60px] p-2 rounded-xl bg-[#2F5FAC] text-white outline-none active:bg-[#183056] hover:bg-[#5483D0] focus:ring-2 ring-violet-300 text-base font-bold ${prop.customStyle}`;
